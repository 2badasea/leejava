...
//		}
	...
	public String ajaxTodoDelete(TodoVO tvo, HttpServletRequest request
			,@RequestParam("m_email") String m_email  
	...
	public String ajaxTodoUpdate(TodoVO tvo, HttpServletRequest request
			,@RequestParam("m_email") String m_email
			,@RequestParam("todo_no") int todo_no
		...
		logger.info("========== 날라온 값 확인: " + m_email + ", todo_no: " + todo_no 
						+ ", todo_status: " + todo_status + " , todo_content: " + todo_content);
		tvo.setM_email(m_email);
		tvo.setTodo_no(todo_no);
