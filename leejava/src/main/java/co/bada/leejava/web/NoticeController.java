...
//		String SAVE_PATH = uploadpath + "/noticeattach/"; //webapp 아래부터 경로를 작성
	...
	public void noticeFileDownload(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception { 
	...
	public String noticeFormUpdate(Model model, HttpServletRequest request, 
	...
	public String ajaxNoticeFileDelete(Model model, HttpServletRequest request
			, NoticeVO nvo, @RequestParam("n_no") int n_no) { 
